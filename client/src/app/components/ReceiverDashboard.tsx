...
export function ReceiverDashboard() {
    ...
    // Selected UPI app (gpay/phonepe/paytm/bhim)
    const [upiApp, setUpiApp] = useState<string | null>(null);

    // Available payment method options (used in JSX)
    ...
    const filteredPosts = foods
        ...
        .sort((a, b) => {
            ...
            return b.expiryTime.getTime() - a.expiryTime.getTime();
        });
    ...
    const handleProcessPayment = async () => {
        ...
        try {
            // Claim the food from backend first
            await api.put(`/food/claim/${selectedFood.id}`);
            console.log('✓ Food claimed successfully');
            ...
            // Refresh the foods list to remove claimed food
            await fetchFoods();
